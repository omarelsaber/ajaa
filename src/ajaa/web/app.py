...
from ajaa.web.routes.profile import router as profile_router
from ajaa.web.routes.settings import router as settings_router
from ajaa.web.routes.metrics import router as metrics_router
